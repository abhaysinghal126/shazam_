<h1 align="center">Shazam_ Algorithm :musical_note:</h1>

## Description 🎼
Shazam_ is an implementation of Shazam's song recognition algorithm based on insights from these [resources](#resources--card_file_box). It integrates Spotify and YouTube APIs to find and download songs.
...
```
git clone https://github.com/abhaysinghal126/shazam_.git
cd shazam_
```
#### 🐳 Set Up with Docker
